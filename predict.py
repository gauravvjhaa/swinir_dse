...
class Predictor(cog.BasePredictor):
    ...
    @cog.Input("image")
    @cog.Input("task_type", choices=["Real-World Image Super-Resolution", "Grayscale Image Denoising", "Color Image Denoising", "JPEG Compression Artifact Reduction"])
    @cog.Input("noise", choices=[15, 25, 50])
    @cog.Input("jpeg", choices=[10, 20, 30, 40])
